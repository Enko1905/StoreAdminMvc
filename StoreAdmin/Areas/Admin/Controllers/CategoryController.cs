...
namespace StoreAdmin.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        {
            return new SelectList(await _serviceManager.MainCategoryService.GetAll(), "Id", "Name", selectedValue);
        }
        [HttpGet]
        ...
        {
            bool veri = await _serviceManager.CategoryService.UpdateOne(categories.Id, categories);
            if (veri)
            {
                TempData["Message"] = basariliMesaj;
                TempData["MessageType"] = "success";
