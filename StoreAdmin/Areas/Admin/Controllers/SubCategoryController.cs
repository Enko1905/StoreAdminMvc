...
namespace StoreAdmin.Areas.Admin.Controllers
{
    ...
    public class SubCategoryController : Controller
    {
        ...
        {
            return new SelectList(await _serviceManager.CategoryService.GetAllById(mainCategoryId), "Id", "Name", selectedValue);
        }
        ...
        {
            var sonuc = await _serviceManager.SubCategoryService.UpdateOne(subCategory.Id,subCategory);
            if (sonuc)
            {
                TempData["Message"] = basariliMesaj;
                TempData["MessageType"] = "success";
